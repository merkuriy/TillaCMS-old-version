	...
	function qformat(){
		...
		return 
			'<div id="q-format_foo1">
				<p id="q-format_foo2">
					'.modules_structure_copyr::$qfomat01[ $CONF['language'] ].'
					<a href="http://q-format.ru" title="'.modules_structure_copyr::$qfomat04[ $CONF['language'] ].'">
						<img src="/images/q-format.png" alt="'.
							modules_structure_copyr::$qfomat03[ $CONF['language'] ].
						' «Q-format»" /> &laquo;Q-format&raquo;
					</a>
					<br/>
					<a href="'.$infoSiteURL.'">'.modules_structure_copyr::$qfomat02[ $CONF['language'] ].'</a>
				</p>
			</div>';
