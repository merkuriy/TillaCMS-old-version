...
/*
		<div id="'+options.id+'Container">
			<div class="quiTreeHead">
				<div id="'+options.id+'RootLabel" class="quiTreeRL">
					<span class="nodeName">Имя узла</span>
					<div class="quiTreeBTN">
						<div class="quiTreeExitF"></div>
						<div class="quiTreeAddN"></div>
					</div>
				</div>
			</div>
			<div id="'+options.id+'" class="quiTree"></div>
		</div>
*/
